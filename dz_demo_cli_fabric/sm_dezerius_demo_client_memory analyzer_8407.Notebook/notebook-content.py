...
dataset = "sm_dezerius_demo_client" # Enter the name or ID of the semantic model
workspace = "ws-dezerius-demo-client-dev" # Enter the workspace name or ID in which the semantic model exists
